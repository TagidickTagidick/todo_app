...
abstract class $TodoListModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(1) List<TodoModel> list,
      @HiveField(2) int revision});
}
...
class _$_TodoListModel implements _TodoListModel {
  const _$_TodoListModel(
      ...
      @HiveField(1) required final List<TodoModel> list,
      @HiveField(2) required this.revision})
      : _list = list;
  ...
  @override
  String toString() {
    return 'TodoListModel(status: $status, list: $list, revision: $revision)';
  }
...
abstract class _TodoListModel implements TodoListModel {
  const factory _TodoListModel(
      ...
      @HiveField(1) required final List<TodoModel> list,
      @HiveField(2) required final int revision}) = _$_TodoListModel;
